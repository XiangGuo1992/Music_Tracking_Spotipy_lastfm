...
os.chdir('YOUR DIC FOR SAVING DATA')

# require your Genius keys from the https://docs.genius.com/
genius = lyricsgenius.Genius("Genius keys")

# You have to have your own unique two values for API_KEY and API_SECRET
# Obtain yours from https://www.last.fm/api/account/create for Last.fm
API_KEY = "LASTFM KEYS"  # this is a sample key
API_SECRET = "LASTFM SECRET"

# In order to perform a write operation you need to authenticate yourself
username = "YOUR LASTFM USERNAME"
password_hash = pylast.md5("YOUR LASTFM PASSWORD")
...
##obtain keys from spotify
username2 = 'YOUR SPOTIFY USERNAME'
...
client_secret = 'CLIENT SECRET FROM YOUR SPOTIFY APP'

token2 = util.prompt_for_user_token(username2,scope,client_id=client_id,\
   client_secret=client_secret,redirect_uri='http://www.google.com/')
sp = spotipy.Spotify(auth = token2)



# search Chinese lyrics in mojim.com
search_url = 'https://mojim.com/song_name.html?t3'
lrc_url = 'https://mojim.com/twthxsong_idx1.htm'


    
def get_song_id(song_name, singer):
...
# for different users, list the usernames you want to track
usernames = ['USERNAMES']
for username in usernames:
    ...
    df = pd.DataFrame(columns = ['Album', 'Playback_date','Timestamp', 'Track','Artist','Song','Corrected_song','Duration',\
